...
async def fetch_cal_academy() -> list[dict[str, Any]]:
    logger.info("[workflow] fetching Cal Academy...")
    events = await fetch_cal_academy_events()
    logger.info("[workflow] Cal Academy: %d events", len(events))
